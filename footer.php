                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="footer-about">
                                ...
                                <a href="about.html" class="btn btn-danger btn-sm text-uppercase fw-semibold px-3 py-2" style="background-color: #d32f2f; border-color: #d32f2f; border-radius: 4px; font-size: 12px;">
                ...
                <div class="modal-body p-4 bg-white">
                    <form id="modalEnquiryForm" onsubmit="handleEnquirySubmit(event)">
                        <div class="mb-3">
                            ...
                            <input type="text" id="modalProductInput" class="form-control" style="border-radius: 6px; padding: 14px 16px; font-size: 1.15rem !important; font-weight: 600 !important; color: #111111 !important;">
                        </div>
                        <div class="row g-3 mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" id="modalCustomerName" class="form-control" required style="border-radius: 6px; padding: 14px 16px; font-size: 1.15rem !important; font-weight: 600 !important; color: #111111 !important;">
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="text" id="modalCompanyName" class="form-control" style="border-radius: 6px; padding: 14px 16px; font-size: 1.15rem !important; font-weight: 600 !important; color: #111111 !important;">
                            </div>
                        </div>
                        <div class="row g-3 mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="tel" id="modalPhoneNumber" class="form-control" required style="border-radius: 6px; padding: 14px 16px; font-size: 1.15rem !important; font-weight: 600 !important; color: #111111 !important;">
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="email" id="modalEmailAddress" class="form-control" required style="border-radius: 6px; padding: 14px 16px; font-size: 1.15rem !important; font-weight: 600 !important; color: #111111 !important;">
                            </div>
                        </div>
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="modalMessageRequirements" rows="3" style="border-radius: 6px; padding: 14px 16px; font-size: 1.15rem !important; font-weight: 600 !important; color: #111111 !important;"></textarea>
                        </div>
